...
<body>
    ...
    <div class="class">
        <div class="container">
            <div class="section-header text-center wow zoomIn" data-wow-delay="0.1s">
                <p>Our Classes</p>
                <h2>PT Class Shedule</h2>
            </div>
            <div class="row">
                <div class="col-12">
                    <ul id="class-filter">
                        <li data-filter="*" class="filter-active">All Classes</li>
                        <li data-filter=".filter-1">Pilates Kickboxing</li>
                        <li data-filter=".filter-2">Hatha Kickboxing</li>
                        <li data-filter=".filter-3">Vinyasa Kickboxing</li>
                    </ul>
                </div>
            </div>
            <div class="row class-container">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 class-item filter-2 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="class-wrap">
                        <div class="class-img">
                            <img src="<c:url value='/images/img/img/class-2.jpg'/>" alt="Image">
                        </div>
                        <div class="class-text">
                            <div class="class-teacher">
                                <img src="<c:url value='/images/img/img/teacher-2.png'/>" alt="Image">
                                <h3>Kate Glover</h3>
                                <a href="">+</a>
                            </div>
                            <h2>Iyengar Kickboxing</h2>
                            <div class="class-meta">
                                <p><i class="far fa-calendar-alt"></i>Sun, Tue, Thu</p>
                                <p><i class="far fa-clock"></i>9:00 - 10:00</p>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 class-item filter-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="class-wrap">
                        <div class="class-img">
                            <img src="<c:url value='/images/img/img/class-3.jpg'/>" alt="Image">
                        </div>
                        <div class="class-text">
                            <div class="class-teacher">
                                <img src="<c:url value='/images/img/img/teacher-3.png'/>" alt="Image">
                                <h3>Elina Ekman</h3>
                                <a href="">+</a>
                            </div>
                            <h2>Ashtanga Kickboxing</h2>
                            <div class="class-meta">
                                <p><i class="far fa-calendar-alt"></i>Sun, Tue, Thu</p>
                                <p><i class="far fa-clock"></i>9:00 - 10:00</p>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 class-item filter-1 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="class-wrap">
                        <div class="class-img">
                            <img src="<c:url value='/images/img/img/class-4.jpg'/>" alt="Image">
                        </div>
                        <div class="class-text">
                            <div class="class-teacher">
                                <img src="<c:url value='/images/img/img/teacher-4.png'/>" alt="Image">
                                <h3>Lilly Fry</h3>
                                <a href="">+</a>
                            </div>
                            <h2>Hatha Kickboxing</h2>
                            <div class="class-meta">
                                <p><i class="far fa-calendar-alt"></i>Sun, Tue, Thu</p>
                                <p><i class="far fa-clock"></i>9:00 - 10:00</p>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 class-item filter-2 wow fadeInUp" data-wow-delay="0.8s">
                    <div class="class-wrap">
                        <div class="class-img">
                            <img src="<c:url value='/images/img/img/class-5.jpg'/>" alt="Image">
                        </div>
                        <div class="class-text">
                            <div class="class-teacher">
                                <img src="<c:url value='/images/img/img/teacher-5.png'/>" alt="Image">
                                <h3>Olivia Yates</h3>
                                <a href="">+</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 class-item filter-3 wow fadeInUp" data-wow-delay="1s">
                    <div class="class-wrap">
                        <div class="class-img">
                            <img src="<c:url value='/images/img/img/class-6.jpg'/>" alt="Image">
                        </div>
                        <div class="class-text">
                            <div class="class-teacher">
                                <img src="<c:url value='/images/img/img/teacher-6.png'/>" alt="Image">
                                <h3>Millie Harper</h3>
                                <a href="">+</a>
                            </div>
                            <h2>Vinyasa yoga</h2>
    ...
    <div class="blog">
        <div class="container">
            ...
            <div class="owl-carousel blog-carousel wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="<c:url value='/images/img/img/blog-2.jpg'/>" alt="Blog">
                    </div>
                    <div class="blog-text">
                        <h2>Lorem ipsum dolor</h2>
                        <div class="blog-meta">
                ...
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="<c:url value='/images/img/img/blog-3.jpg'/>" alt="Blog">
                    </div>
                    <div class="blog-text">
                        <h2>Lorem ipsum dolor</h2>
                        <div class="blog-meta">
                ...
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="<c:url value='/images/img/img/blog-4.jpg'/>" alt="Blog">
                    </div>
                    <div class="blog-text">
                        <h2>Lorem ipsum dolor</h2>
                        <div class="blog-meta">
                ...
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="<c:url value='/images/img/img/blog-5.jpg'/>" alt="Blog">
                    </div>
                    <div class="blog-text">
                        <h2>Lorem ipsum dolor</h2>
                        <div class="blog-meta">
                ...
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="<c:url value='/images/img/img/blog-6.jpg'/>" alt="Blog">
                    </div>
                    <div class="blog-text">
                        <h2>Lorem ipsum dolor</h2>
                        <div class="blog-meta">
...
<script src="${projectPath}/js/index.js?1.1"></script>
<!-- Footer End -->
