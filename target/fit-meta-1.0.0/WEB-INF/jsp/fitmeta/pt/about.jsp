...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="${projectPath}/css/assets/vendor/perfect-scrollbar/css/perfect-scrollbar.css">
...
<body class="theme-red">
  ...
  <div class="vg-page page-home" id="home" style="background-image: url(../css/assets/img/bg_banner.jpg)">
    ...
    <div class="navbar navbar-expand-lg navbar-dark sticky" data-offset="500">
      <div class="container">
        <a href="/fit-meta/pt/index.do" class="navbar-brand">Fit-Meta</a>
        ...
        <div class="collapse navbar-collapse" id="main-navbar">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a href="#home" class="nav-link" data-animate="scrolling">Top</a>
            </li>
            <li class="nav-item">
              <a href="#about" class="nav-link" data-animate="scrolling">About</a>
            </li>
            <li class="nav-item">
              <a href="#blog" class="nav-link" data-animate="scrolling">News</a>
            </li>
            <li class="nav-item">
    ...
    <div class="caption-header text-center wow zoomInDown">
      ...
      <div class="badge">Personal Trainer</div>
      ...
      <div class="row">
        <div class="col-lg-4 py-3">
          <div class="img-place wow fadeInUp">
            <img src="${projectPath}/css/assets/img/hideki.png" alt="">
          </div>
        </div>
        <div class="col-lg-6 offset-lg-1 wow fadeInRight">
          <h1 class="fw-light">Stephen Doe</h1>
          <h5 class="fg-theme mb-3">Personal Trainer</h5>
  ...
  <script src="${projectPath}/css/assets/vendor/perfect-scrollbar/js/perfect-scrollbar.js"></script>
  ...
  <script src="${projectPath}/css/assets/js/google-maps.js"></script>
