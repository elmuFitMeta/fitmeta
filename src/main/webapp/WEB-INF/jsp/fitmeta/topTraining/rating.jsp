...
<body>
    ...
    <div class="navbar navbar-expand-lg bg-dark navbar-dark">
        <div class="container-fluid">
            <a href="/fit-meta/index.do" class="navbar-brand">FITMETA</a>
    ...
    <div class="container">
        ...
        <img id="class-img" src="" class="img-fluid center" alt="Responsive image"> <br> <br>
        <div class="card">
...
<script src="${projectPath}/js/top-training/u-rating.js?1.2"></script>